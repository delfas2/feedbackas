...
urlpatterns = [
    ...
    path('superadmin/companies/<int:company_id>/delete/', views.superadmin_delete_company, name='superadmin_delete_company'),
    ...
    path('superadmin/companies/<int:company_id>/employees/import/', views.superadmin_import_employees, name='superadmin_import_employees'),
    ...
    path('superadmin/companies/<int:company_id>/toggle-admin/<int:user_id>/', views.superadmin_toggle_admin, name='superadmin_toggle_admin'),
    path('superadmin/companies/<int:company_id>/billing/', views.superadmin_company_billing, name='superadmin_company_billing'),
