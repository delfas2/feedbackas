...
urlpatterns = [
    ...
    path('feedback/request/', views.request_feedback, name='request_feedback'),
    path('feedback/send/<int:user_id>/', views.send_feedback, name='send_feedback'),
    ...
    path('feedback/results/', views.results, name='results'),
    path('feedback/generate_ai_feedback/', views.generate_ai_feedback, name='generate_ai_feedback'),
]
