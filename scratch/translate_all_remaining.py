...
translations = {
    ...
    'Vadovas:': 'Manager:',
    'Nėra paskirto vadovo': 'No manager assigned',
    'nariai': 'members',
    'Ar tikrai norite ištrinti padalinį': 'Are you sure you want to delete the department',
    'Visi sub-padaliniai taip pat bus ištrinti.': 'All sub-departments will also be deleted.'
}
...
print("Updated PO with all remaining translations")
